...
class TelemetryWorker(
    ...
    private fun collectTelemetry(): TelemetryMetric {
        val (batteryPct, isCharging) = getBatteryStatus()
        val (ramUsagePct, ramUsedBytes) = getMemoryUsage()
    ...
    private fun getMemoryUsage(): Pair<Double, Long> {
        return try {
